...
module.exports = async(req,res)=>{
    ...
    try{
        const [result] = await pool.query(`SELECT COUNT(d.id) AS cantidad, m.id_estado, e.descripcion AS estado
            FROM documento AS d 
            ...
            ORDER BY FIELD(e.descripcion, 'Completado', 'En Curso','Demorado')`);
